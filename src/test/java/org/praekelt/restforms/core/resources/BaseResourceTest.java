...
public class BaseResourceTest {
    ...
    public void testToJson() {
        ...
        assertNotNull(BaseResource.toJson(new BaseResource.BaseResponse(123, "abc"), BaseResource.BaseResponse.class));
    ...
    public void testUpdateResource_3args() {
        ...
        assertTrue(instance.updateResource("test-key", "field1", "new-value1"));
    ...
    public void testUpdateResource_String_byteArr() {
        System.out.println("updateResource");
        assertTrue(instance.updateResource("test-key", "new-value3".getBytes()));
